...
# SEO v7.4.1 Migration Report — Lite
...
Lite reduces reporting depth and formatting overhead; it does not weaken evidence states, critical-defect handling, policy gates, retry/stop conditions, or controller authority.
