...
For publication/indexation work or when policy/ranking-risk indicators are found, route Module 09 findings to Module 10 before final Module 07 QA. This routing is automatic when the controller trigger applies.
