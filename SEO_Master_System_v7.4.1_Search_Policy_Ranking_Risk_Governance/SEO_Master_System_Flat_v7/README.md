...
# SEO Master System v7 — Full / Audit Flat GPT Edition
...
| Final specialist QA, repair, or compact verdict | `MODULE_07_QA_AND_RECOVERY.md` |
...
10. Run `MODULE_07_QA_AND_RECOVERY.md` as the specialist QA step.
...
|---|---|
| Humanize or audit one existing article | Controller → canonical context → `MODULE_02_CONTENT_PRODUCTION.md` when revision is required → `MODULE_09_BATCH_HUMANIZATION_AND_DETECTOR_GOVERNANCE.md` Mode A → `MODULE_10_SEARCH_POLICY_AND_RANKING_RISK_GOVERNANCE.md` → `MODULE_07_QA_AND_RECOVERY.md` → controller verdict |
| Create and audit one new article | Controller → canonical context → `MODULE_01_INTENT_ARCHITECTURE.md` when intent architecture is needed → `MODULE_02_CONTENT_PRODUCTION.md` → `MODULE_09_BATCH_HUMANIZATION_AND_DETECTOR_GOVERNANCE.md` Mode A → `MODULE_10_SEARCH_POLICY_AND_RANKING_RISK_GOVERNANCE.md` → `MODULE_07_QA_AND_RECOVERY.md` → controller verdict |
