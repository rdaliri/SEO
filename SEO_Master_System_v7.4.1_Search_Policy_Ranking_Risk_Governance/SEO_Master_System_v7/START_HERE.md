...
7. Run `modules/07_QA_AND_RECOVERY.md` for specialist QA, then let the controller issue the final verdict.
8. Do not load archived files, competing controllers, or Flat and Modular copies together.

## Common Loading Examples
| Request | Load |
|---|---|
| Content brief | `modules/01_INTENT_ARCHITECTURE.md`, `modules/02_CONTENT_PRODUCTION.md`, `modules/10_SEARCH_POLICY_AND_RANKING_RISK_GOVERNANCE.md`, `modules/07_QA_AND_RECOVERY.md` |
| Technical SEO audit | `modules/03_TECHNICAL_SEO.md`, `modules/10_SEARCH_POLICY_AND_RANKING_RISK_GOVERNANCE.md`, `modules/07_QA_AND_RECOVERY.md` |
| Local SEO task | `modules/01_INTENT_ARCHITECTURE.md`, `modules/04_LOCAL_AND_SCALED_CONTENT.md`, `modules/10_SEARCH_POLICY_AND_RANKING_RISK_GOVERNANCE.md`, `modules/07_QA_AND_RECOVERY.md` |
| AI-search visibility task | `modules/06_AI_SEARCH_VISIBILITY.md`, `modules/07_QA_AND_RECOVERY.md`; optionally `REFERENCE_QUERY_FANOUT_AND_SOURCE_ELIGIBILITY_v7.md` |
| Publishable article with image prompts | `modules/02_CONTENT_PRODUCTION.md`, `modules/08_IMAGE_GENERATION.md`, `modules/10_SEARCH_POLICY_AND_RANKING_RISK_GOVERNANCE.md`, `modules/07_QA_AND_RECOVERY.md` |
| Single-asset humanization audit | `modules/02_CONTENT_PRODUCTION.md` when revision is required, `modules/09_BATCH_HUMANIZATION_AND_DETECTOR_GOVERNANCE.md` Mode A, `modules/10_SEARCH_POLICY_AND_RANKING_RISK_GOVERNANCE.md`, `modules/07_QA_AND_RECOVERY.md` |
| Related content-batch audit | `modules/01_INTENT_ARCHITECTURE.md`, `modules/02_CONTENT_PRODUCTION.md`, `modules/09_BATCH_HUMANIZATION_AND_DETECTOR_GOVERNANCE.md` Mode B, `modules/04_LOCAL_AND_SCALED_CONTENT.md` when scaled/local risk applies, `modules/10_SEARCH_POLICY_AND_RANKING_RISK_GOVERNANCE.md`, `modules/07_QA_AND_RECOVERY.md` |
| Supplied detector-result review | Run `modules/09_BATCH_HUMANIZATION_AND_DETECTOR_GOVERNANCE.md` Mode A or B first, then add Mode C; finish with `modules/10_SEARCH_POLICY_AND_RANKING_RISK_GOVERNANCE.md`, `modules/07_QA_AND_RECOVERY.md` |
...
5. Run `modules/07_QA_AND_RECOVERY.md` after Module 09 and let the controller issue the final verdict.
