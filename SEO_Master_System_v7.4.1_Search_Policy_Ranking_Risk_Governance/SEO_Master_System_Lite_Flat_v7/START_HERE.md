...
7. Run `MODULE_07_QA_VERDICT.md` for specialist QA, then let the controller issue the final verdict.
8. Do not load archived files, competing controllers, or Flat and Modular copies together.

## Common Loading Examples
| Request | Load |
|---|---|
| Content brief | `MODULE_01_INTENT_ARCHITECTURE.md`, `MODULE_02_CONTENT_PRODUCTION.md`, `MODULE_10_SEARCH_POLICY_AND_RANKING_RISK_GOVERNANCE.md`, `MODULE_07_QA_VERDICT.md` |
| Technical SEO audit | `MODULE_03_TECHNICAL_SEO.md`, `MODULE_10_SEARCH_POLICY_AND_RANKING_RISK_GOVERNANCE.md`, `MODULE_07_QA_VERDICT.md` |
| Local SEO task | `MODULE_01_INTENT_ARCHITECTURE.md`, `MODULE_04_LOCAL_AND_SCALED_CONTENT.md`, `MODULE_10_SEARCH_POLICY_AND_RANKING_RISK_GOVERNANCE.md`, `MODULE_07_QA_VERDICT.md` |
| AI-search visibility task | `MODULE_06_AI_SEARCH_VISIBILITY.md`, `MODULE_07_QA_VERDICT.md`; optionally `REFERENCE_QUERY_FANOUT_AND_SOURCE_ELIGIBILITY_v7.md` |
| Publishable article with image prompts | `MODULE_02_CONTENT_PRODUCTION.md`, `MODULE_08_IMAGE_GENERATION.md`, `MODULE_10_SEARCH_POLICY_AND_RANKING_RISK_GOVERNANCE.md`, `MODULE_07_QA_VERDICT.md` |
| Single-asset humanization audit | `MODULE_02_CONTENT_PRODUCTION.md` when revision is required, `MODULE_09_BATCH_HUMANIZATION_AND_DETECTOR_GOVERNANCE.md` Mode A, `MODULE_10_SEARCH_POLICY_AND_RANKING_RISK_GOVERNANCE.md`, `MODULE_07_QA_VERDICT.md` |
| Related content-batch audit | `MODULE_01_INTENT_ARCHITECTURE.md`, `MODULE_02_CONTENT_PRODUCTION.md`, `MODULE_09_BATCH_HUMANIZATION_AND_DETECTOR_GOVERNANCE.md` Mode B, `MODULE_04_LOCAL_AND_SCALED_CONTENT.md` when scaled/local risk applies, `MODULE_10_SEARCH_POLICY_AND_RANKING_RISK_GOVERNANCE.md`, `MODULE_07_QA_VERDICT.md` |
| Supplied detector-result review | Run `MODULE_09_BATCH_HUMANIZATION_AND_DETECTOR_GOVERNANCE.md` Mode A or B first, then add Mode C; finish with `MODULE_10_SEARCH_POLICY_AND_RANKING_RISK_GOVERNANCE.md`, `MODULE_07_QA_VERDICT.md` |
...
5. Run `MODULE_07_QA_VERDICT.md` after Module 09 and let the controller issue the final verdict.
