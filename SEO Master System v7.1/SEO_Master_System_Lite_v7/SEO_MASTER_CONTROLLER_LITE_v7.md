...
- Intent, keywords, architecture, cannibalization: `modules/01_INTENT_ARCHITECTURE.md`
- New or refreshed content: `modules/02_CONTENT_PRODUCTION.md`
- Crawl, indexation, rendering, schema, implementation: `modules/03_TECHNICAL_SEO.md`
- Local or scaled pages: `modules/04_LOCAL_AND_SCALED_CONTENT.md`
- Retain, refresh, merge, redirect, noindex, retire: `modules/05_CONTENT_LIFECYCLE.md`
- AI-search retrieval/citation readiness: `modules/06_AI_SEARCH_VISIBILITY.md`
- Post-content image specification: `modules/08_IMAGE_GENERATION.md`
- Final QA or repair: `modules/07_QA_VERDICT.md`
