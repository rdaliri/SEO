...
## v7.2 Humanization Governance Release

This release adds Module 09 and `TEAM_MANUAL_MODULE_09.md` to all four package variants. Choose one package variant and do not mix files across variants. Module 09 governs detector evidence and related-content batch fingerprinting; it does not guarantee detector passage or determine authorship.
