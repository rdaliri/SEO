...
| Request | Load |
|---|---|
| Content brief | `MODULE_01_INTENT_ARCHITECTURE.md`, `MODULE_02_CONTENT_PRODUCTION.md`, `MODULE_07_QA_AND_RECOVERY.md` |
| Technical SEO audit | `MODULE_03_TECHNICAL_SEO.md`, `MODULE_07_QA_AND_RECOVERY.md` |
| Local SEO task | `MODULE_01_INTENT_ARCHITECTURE.md`, `MODULE_04_LOCAL_AND_SCALED_CONTENT.md`, `MODULE_07_QA_AND_RECOVERY.md` |
...
| Publishable article with image prompts | `MODULE_02_CONTENT_PRODUCTION.md`, `MODULE_08_IMAGE_GENERATION.md`, `MODULE_07_QA_AND_RECOVERY.md` |
