...
| Request | Load |
|---|---|
| Content brief | `modules/01_INTENT_ARCHITECTURE.md`, `modules/02_CONTENT_PRODUCTION.md`, `modules/07_QA_AND_RECOVERY.md` |
| Technical SEO audit | `modules/03_TECHNICAL_SEO.md`, `modules/07_QA_AND_RECOVERY.md` |
| Local SEO task | `modules/01_INTENT_ARCHITECTURE.md`, `modules/04_LOCAL_AND_SCALED_CONTENT.md`, `modules/07_QA_AND_RECOVERY.md` |
...
| Publishable article with image prompts | `modules/02_CONTENT_PRODUCTION.md`, `modules/08_IMAGE_GENERATION.md`, `modules/07_QA_AND_RECOVERY.md` |
